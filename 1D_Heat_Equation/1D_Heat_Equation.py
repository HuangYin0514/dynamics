...
if __name__ == "__main__":
    ...
    pinn = pf.PINN(model, 2, 1, pde_loss, initial_condition, [dirichlet_bc_u_lb,dirichlet_bc_u_ub], use_gpu=use_gpu)
    
    # logger = pf.WandbLogger("1D Heat equation pinn",args)
    
    # train pinn
    pinn.fit(args.num_epochs, checkpoint_path='checkpoint.pt', restart=True, logger=None,lbfgs_finetuning=False, pretraining = True)
